...
router.post("/profit_investment", async (req, res) => {
  try {
...
router.post("/donation_investment", async (req, res) => {
  try {
...
router.post("/equity_investment", async (req, res) => {
  try {
...
router.post("/reward_investment", async (req, res) => {
  try {
